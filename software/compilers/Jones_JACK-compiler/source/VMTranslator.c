...
int main( int argc, char ** argv )
{
	...
	//get_list_of_vm_files(argv[1], list_of_vm_files, num_vm_files);
	...
	if( folder != NULL )
	{
		...
		extract_project_folder_and_asm_filename_from_directory(argv[1], project_folder, asm_filename);
